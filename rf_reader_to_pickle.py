# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 18:48:52 2020
...
for counter in range(length):
    ...
    (img,amplitude_envelope,label,lesion_type,isValid) = bmode(rf,labels,filename)
    out_file_name = cc_bmp_folder 
    
    if isValid:
        labelRow = {}
        labelRow[0] = label 
        labelRow[1] = amplitude_envelope
        labelRow[2] = lesion_type.upper()

        npList.append(labelRow)

with open('label_names', 'wb') as outfile:
    pickle.dump(npList, outfile)
